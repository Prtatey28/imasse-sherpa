...
<body style="display: none">
  ...
  <div class="container">
    ...
    <p style="position: bottom; text-align:center; font-size:18px;"><b>NOTE:</b> Multiple year classes are subjugated by "I" not "#." Ex: Algebra 2 = Algebra II. Also, Math 4th year is its own class, make sure to add it if it applies to you!</p>
